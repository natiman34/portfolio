  ...
  return <section id="portfolio" className="py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-16 slide-up">
          ...
          {projects.map(project => <Card key={project.id} className="card-gradient shadow-card hover-glow max-w-4xl mx-auto">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-2">
                    {project.features.map((feature, index) => <div key={index} className="flex items-center space-x-2">
        ...
        <div className="slide-up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {comingSoonProjects.map((project, index) => <Card key={index} className="card-gradient shadow-card hover-glow">
